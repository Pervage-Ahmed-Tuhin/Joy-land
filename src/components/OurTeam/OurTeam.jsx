        ...
        <div className='max-w-6xl mx-auto mt-7'>
            <section className="py-6 dark:bg-gray-100 dark:text-gray-800">
                <div className="container flex flex-col items-center justify-center p-4 mx-auto sm:p-10">
                    <p className="p-2 text-3xl font-play-fare font-bold text-center mt-9  tracking-wider  uppercase">Development team</p>
                    ...
                    <div className="flex flex-row flex-wrap-reverse justify-center mt-8">
                        <div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-[#00BFA6] dark:text-gray-100">
